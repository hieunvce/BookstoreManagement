...
public class ResultSetImpl implements ResultSetInternalMethods {
     ...
     * @throws SQLException if a database-access error occurs, or the condition 0 lteq
    ...
    /**
     * @param nextResultSet Sets the next result set in the result set chain for multiple
     *                      result sets.
     */
