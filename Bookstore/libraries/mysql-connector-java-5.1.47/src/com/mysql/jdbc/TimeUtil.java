...
public class TimeUtil {
     ...
     * @throws SQLException if fsp value is out of range
     */
     ...
     * @param serverSupportsFracSecs flag indicating does server support fractional seconds
     * @param fsp                    required fractional part length
     * @return fractional seconds part as a string
     * @throws SQLException if nanos or fsp value is out of range
     */
     ...
     *
     * @param origCalendar original Calendar
     * @param refCalendar  reference Calendar
